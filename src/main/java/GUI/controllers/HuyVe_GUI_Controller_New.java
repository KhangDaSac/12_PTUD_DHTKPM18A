...
private HoaDonHuyVe hoaDonHuyVe = new HoaDonHuyVe();
    ...
    public void hienThiVeTim(Ve ve) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/HuyVe_GUI_ITems/Ve_TimVe.fxml"));
            Parent anchorPane = loader.load();
    ...
    public void hienThiVeHuy(ArrayList<Ve> dsVe ) {
        ...
        for(Ve ve :dsVe){
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/HuyVe_GUI_ITems/Ve_HuyVe.fxml"));
                Parent anchorPane = loader.load();
                Ve_HuyVe_HuyVe_Controller_Test controller = loader.getController();
    ...
    ChiTietHoaDonHuyVe_DAO.themDanhsachChiTietHoaDonHuyVe(dschiTietHoaDonHuyVe);
