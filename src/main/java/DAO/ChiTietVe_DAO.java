...
public class ChiTietVe_DAO {
    ...
    public static ArrayList<ChiTietVe> xuatDanhSachChiTietVeTheoMaVe(String maVe){
        ...
        String query = "select CTV.maVe, CTV.maCho, CTV.maKhachHang, CTV.giaCho, CTV.phanTramGiamGia\n" +
                "from ChiTietVe\n" +
                "as CTV JOIN Ve AS V ON CTV.maVe = V.maVe\n" +
                "WHERE V.maVe = ?\n" +
                "group by CTV.maVe, CTV.maCho, CTV.maKhachHang, CTV.giaCho, CTV.phanTramGiamGia";
        try{
            PreparedStatement statement = con.prepareStatement(query);
